            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="icon-box icon-box-boxed2-about">
                        <h4>Quiénes somos</h4>
                        <h5>El despacho</h5>
                        <p class="description-3">Somos una firma integral de contadores fundada en el año 1995 que ha mantenido un crecimiento año con año. Actualmente estamos conformados por cinco áreas de servicio, contabilidad, nóminas y seguridad social, auditoria, jurídico y recursos humanos; así mismo contamos con una red de profesionales expertos en distintas áreas complementarias a éstas para lograr brindar un servicio completo a nuestros clientes. </p>
