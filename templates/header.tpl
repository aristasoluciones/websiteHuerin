<div id="navigation-1" class="navbar navbar-fixed-top navbar-uppercase navbar-inverse navbar-transparent tersus-navigation-5">
    <div class="bind-narrow bind-narrow-md">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                {if $page ne "homepage"}
                <a class="navbar-brand" href="{$WEB_ROOT}"><img src="{$WEB_ROOT}/assets/img/logos/logo.png" alt="B&H"/></a>
                {/if}
            </div>
            <div id="navigation-1-collapse" class="navbar-offcanvas offcanvas navbar-right canvas-push">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{$WEB_ROOT}/nosotros" class="noEfect">acerca de nosotros</a></li>
                    <li><a href="{$WEB_ROOT}/areas" class="noEfect">Areas de servicio</a></li>
                    {*<li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Areas de servicio <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{$WEB_ROOT}/auditoria"><i class="fa fa-circle huerin-menu"></i>Auditoría</a></li>
                            <!--<li><a href="{$WEB_ROOT}/administracion"><i class="fa fa-circle huerin-menu"></i>Administración</a></li>-->
