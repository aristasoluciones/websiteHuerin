            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="icon-box icon-box-boxed2-huerin">
                        ...
                        <ul class="list-group">
                            <li><a href='javascript:void(0);' class="list-body noEfect" id="audit-7"><i class="fa fa-circle huerin-orange"></i>Cambio de domicilio, apertura o cierre de establecimiento o sucursales.</a>
                            ...
                            <li><a href='javascript:void(0);' class="list-body noEfect" id="audit-11"><i class="fa fa-circle huerin-orange"></i>Revisión a requerimientos de las diferentes autoridades.</a>
                               <div class="circle-detail popup-detail" id="audit-11">
                                </div>
                            </li>
                            <li><a href='javascript:void(0);' class="list-body noEfect" id="audit-12"><i class="fa fa-circle huerin-orange"></i>Revisión a auditorias de las diferentes autoridades.</a>
