<div class="section spacing-default tersus-block-services-9" id="contabilidad">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="icon-box icon-box-boxed2-huerin">
                        <h4>Contabilidad</h4>
                        <p>Contamos con un equipo de profesionales capacitados para desarrollar estrategias efectivas que llevaran a tu empresa cumplir correctamente con las obligaciones fiscales.</p>
                            ...
                            <li><a href='javascript:void(0);' class="list-body" id="audit-5"><i class="fa fa-circle huerin-orange"></i>Arrendamiento de inmuebles</a>
                                <div class="circle-detail popup-detail" id="audit-5">
                                    <div class="content-circle">
                                        ...
                                        <p class="body-circle-detail">Si eres persona física y tiene ingresos por la renta de departamentos, casa habitación o local comercial</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li><a href='javascript:void(0);' class="list-body" id="audit-8"><i class="fa fa-circle huerin-orange"></i>Contabilidad electrónica</a>
                                <div class="circle-detail popup-detail" id="audit-8">
                                    <div class="content-circle">
                                        ...
                                        <p class="body-circle-detail">Hoy en día es una obligación hacer y presentar mensualmente la contabilidad de forma electrónica</p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="list-group">
                            ...
                            <li><a href='javascript:void(0);' class="list-body" id="audit-13"><i class="fa fa-circle huerin-orange"></i>Asesoría contable y fiscal</a>
                                <div class="circle-detail popup-detail">
                        ...
                        <ul class="list-group">
                            ...
                            <li><a href='javascript:void(0);' class="list-body" id="audit-17"><i class="fa fa-circle huerin-orange"></i>Tramite de las claves obligatorias de las diferentes autoridades</a>
                                <div class="circle-detail popup-detail" id="audit-17">
                                    <div class="content-circle">
                            ...
                            <li><a href='javascript:void(0);' class="list-body" id="audit-18"><i class="fa fa-circle huerin-orange"></i>Aumento o disminucion de obligaciones</a>
                                <div class="circle-detail popup-detail" id="audit-18">
                                    <div class="content-circle">
                                        <h4 class="title-circle-detail">Aumento o disminucion de obligacionesl</h4>
                                        <p class="body-circle-detail">Visite el area de contacto para mas información</p>
                                    </div>
                                </div>
                            </li>
